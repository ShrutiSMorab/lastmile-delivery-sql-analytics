...
**Also in this repo:** the same case study as a formatted [Word report](Indirect-Spend-Optimisation-Case-Study.docx) and an [11-slide executive deck](Indirect-Spend-Optimisation-Deck.pptx) with speaker notes.
